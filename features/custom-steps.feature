Feature: Custom Business Logic Testing
  ...
  Background:
    Given I have a data processing pipeline with bucket "my-example-bucket"
    And I have a data processor Lambda named "my-example-lambda"
    And I have a notification system with SQS queue "my-example-queue"
